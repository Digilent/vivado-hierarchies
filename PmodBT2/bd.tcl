...
# Hierarchical cell: PmodBT2_0
proc create_hier_cell_PmodBT2_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_PmodBT2_0() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net AXI_LITE_GPIO_1 [get_bd_intf_pins AXI_LITE_GPIO] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net AXI_LITE_UART_1 [get_bd_intf_pins AXI_LITE_UART] [get_bd_intf_pins axi_uart16550_0/S_AXI]
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodBT2_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
