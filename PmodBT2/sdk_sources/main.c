...
void DemoInitialize() {
   ...
   BT2_Begin (
      &myDevice,
	  XPAR_PMODBT2_0_AXI_GPIO_0_BASEADDR, //XPAR_PMODBT2_0_AXI_LITE_GPIO_BASEADDR,
	  XPAR_PMODBT2_0_AXI_UART16550_0_BASEADDR, //XPAR_PMODBT2_0_AXI_LITE_UART_BASEADDR,
